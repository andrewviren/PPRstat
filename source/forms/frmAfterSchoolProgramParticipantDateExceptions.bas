...
Private Sub cmdPrintReport_Click()
    DoCmd.OpenReport "rptAfterSchoolCountParticipantsAttendance", acViewPreview
    DoCmd.OpenForm "frmAfterSchoolProgramParticipantDateExceptions", , , , , acHidden
