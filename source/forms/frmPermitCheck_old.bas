...
Begin Form
    ...
    Caption ="Assign Checks to Permits"
        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    FontSize =14
                    TabIndex =1
                    ColumnInfo ="\"\";\"\";\"\";\"\";\"\";\"\";\"\";\"$#,##0.00;($#,##0.00)\";\"10\";\"510\""
                    Name ="cmbCheckID"
                    ControlSource ="CheckID"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblCheck.ID, tblCheck.CheckNumber, tblCheck.AccountName, tblCheck.Amount "
                        "FROM tblCheck ORDER BY tblCheck.CheckNumber, tblCheck.CheckDate DESC; "
                    ColumnWidths ="0;1080;4680;1440"
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:\"><Statements><Action Name=\"CloseWindow\"><Argument Name=\"ObjectType\">F"
                                "orm</Argument><Argument Name=\"ObjectName\">frmpermitCheck</Argument></Action></"
...
Private Sub Form_Load()
    Dim Db As Database
    Dim rs As Recordset
    Dim intPublishID As Integer
        
    Set Db = CurrentDb()
    Set rs = Me.RecordsetClone
    
    intPublishID = Forms!frmOutdoorsports.txtPermitID
    rs.FindFirst "PermitID = " & intPublishID
    DoCmd.GoToRecord
    ...
    Me.txtPermitID.DefaultValue = Forms!frmOutdoorsports.txtPermitID
