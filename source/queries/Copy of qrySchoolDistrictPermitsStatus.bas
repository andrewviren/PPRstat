dbMemo "SQL" ="SELECT SDP_to_PPR_out.LocUsageID, SDP_to_PPR_out.LocUsageStatus, tblPermit.Appli"
    ...
    "le.ActivityID=tblPermit.ActivityID) ON (SDP_to_PPR_out.LocUsageInputDateTime=tbl"
    "Permit.DateTimeEntered) AND (SDP_to_PPR_out.LocUsageInputEmpID=tblPermit.Issuer)"
