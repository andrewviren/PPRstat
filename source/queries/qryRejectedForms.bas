...
Begin OutputColumns
    ...
    Expression ="tblRejectedForm.DateTimeEntered"
    Alias ="DateRejected"
    Expression ="DateValue([TblRejectedForm].[DateTimeEntered])"
    Expression ="tblRejectedForm.ActionRequired"
End
Begin Joins
...
Begin
    ...
    End
    Begin
        dbText "Name" ="tblRejectedForm.DateTimeEntered"
        dbLong "AggregateType" ="-1"
        dbInteger "ColumnWidth" ="2250"
        dbBoolean "ColumnHidden" ="0"
    End
    Begin
        dbText "Name" ="DateRejected"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="tblRejectedForm.ActionRequired"
        dbLong "AggregateType" ="-1"
    End
End
Begin
