dbMemo "SQL" ="SELECT qryScheduledDatesDaysTimes.*, qryFacilityPrograms.*, qryFacilityPermits.*"
    ...
    "duledDatesDaysTimes.ActivityID = qryFacilityPermits.ActivityID) LEFT JOIN qryFac"
    "ilityPrograms ON qryScheduledDatesDaysTimes.ActivityID = qryFacilityPrograms.Act"
    "ivityID;\015\012"
dbMemo "Connect" =""
