dbMemo "SQL" ="SELECT tblActivityScheduleAmenity.ActivityScheduleID, ConcatRelated(\"[AmenityNa"
    ...
    "ActivitySchedule.ActivityID = qrySelectedPermits.ActivityID) INNER JOIN tblActiv"
    "ityScheduleAmenity ON tblActivitySchedule.ActivityScheduleID = tblActivitySchedu"
    "leAmenity.ActivityScheduleID;\015\012"
dbMemo "Connect" =""
