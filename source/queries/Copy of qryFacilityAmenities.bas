dbMemo "SQL" ="UPDATE ([FacilityAmenity like hockey] INNER JOIN AmenityType ON [FacilityAmenity"
    ...
    "N Facility ON FacilityAmenities.FacilityID=Facility.FacilityID) ON (AmenityType."
    "ID=FacilityAmenities.TypeID) AND ([FacilityAmenity like hockey].FacilityName=Fac"
    "ility.FacilityName) SET FacilityAmenities.Description = [FacilityAmenity like ho"
