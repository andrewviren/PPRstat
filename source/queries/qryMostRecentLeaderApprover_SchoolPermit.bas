dbMemo "SQL" ="SELECT qryLeaderApprover_SchoolPermit.*\015\012FROM qryLeaderApprover_SchoolPerm"
    ...
    "mit.SchoolName = qryMostRecentApproval_SchoolPermit.SchoolName) AND (qryLeaderAp"
    "prover_SchoolPermit.DateTimeEntered = qryMostRecentApproval_SchoolPermit.MaxOfDa"
    "teTimeEntered);\015\012"
dbMemo "Connect" =""
